...
const AdminRealTimeStats: React.FC<AdminRealTimeStatsProps> = ({ 
  stats, 
  period, 
  onPeriodChange, 
  onRefresh,
  ...
  const statCards = [
    {
      ...
      trend: 'up' as const,
      trendValue: '+15%',
      description: `Période: ${period === 'today' ? 'Aujourd\'hui' : period === 'week' ? 'Cette semaine' : period === 'month' ? 'Ce mois' : 'Cette année'}`,
      color: 'text-blue-600'
    },
    {
      title: 'Revenus',
      ...
      trend: 'up' as const,
      trendValue: '+12%',
      description: `Moyenne: ${formatCurrency(stats?.totalRevenue && stats?.totalOrders ? stats.totalRevenue / stats.totalOrders : 0)}`,
