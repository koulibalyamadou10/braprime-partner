...
const MOCK_MARKET = {
  id: 1,
  name: "Marché Madina",
  coverImage: "https://images.unsplash.com/photo-1513125370-3573e15dae4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
  logo: "https://images.unsplash.com/photo-1513125370-3573e15dae4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
  description: "Le plus grand marché de Conakry offrant une variété de produits frais, d'épices, de tissus et d'artisanat local. Explorez l'atmosphère animée et trouvez tout ce dont vous avez besoin.",
  marketType: "Marché Traditionnel",
  rating: 4.5,
  reviewCount: 87,
  deliveryTime: "35-50 min",
  deliveryFee: "25,000 GNF",
  address: "Avenue de la République, Quartier Madina, Conakry",
  phone: "+224 622 45 67 89",
  openingHours: "07:00 - 19:00",
  categories: [
    { id: 1, name: "Populaires" },
    { id: 2, name: "Fruits & Légumes" },
    { id: 3, name: "Épices & Condiments" },
    { id: 4, name: "Tissus & Vêtements" },
    { id: 5, name: "Artisanat" },
    { id: 6, name: "Produits Divers" }
  ],
  products: [
    {
      id: 1,
      name: "Piment Local",
      description: "Piments rouges frais vendus au kilo",
      price: 10000,
      image: "https://images.unsplash.com/photo-1588252303782-cb80119abd6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: true,
      categoryId: 3
    },
    {
      ...
      description: "Mangues locales de saison, vendues au kilo",
      price: 15000,
      image: "https://images.unsplash.com/photo-1553279768-865429fa0078?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: true,
      categoryId: 2
    },
    {
      id: 3,
      name: "Tissu Wax",
      description: "Tissu traditionnel coloré, 2 mètres",
      price: 50000,
      image: "https://images.unsplash.com/photo-1534653299134-96a171b61581?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: false,
      categoryId: 4
    },
    {
      id: 4,
      name: "Panier Tressé",
      description: "Panier artisanal en feuilles de palmier",
      price: 35000,
      image: "https://images.unsplash.com/photo-1595231776515-ddffb1f4eb73?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: true,
      categoryId: 5
    },
    {
      ...
      description: "Mélange d'épices pour cuisine guinéenne",
      price: 20000,
    ...
    },
    {
      id: 6,
      name: "Oignons Rouges",
      description: "Oignons rouges locaux, vendus au kilo",
      price: 12000,
  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 my-6">
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-700">{market.phone}</span>
            </div>
            <div className="flex items-center">
              <Clock className="h-5 w-5 text-guinea-red mr-2" />
              <span className="text-gray-700">Ouvert: {market.openingHours}</span>
            </div>
            <div className="flex items-center">
              <Info className="h-5 w-5 text-guinea-red mr-2" />
              <span className="text-gray-700">Frais de livraison: {market.deliveryFee}</span>
            </div>
          </div>
        ...
        {/* Products */}
        <Tabs defaultValue={market.categories[0].id.toString()} className="w-full">
