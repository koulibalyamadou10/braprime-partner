...
const MOCK_ELECTRONICS_STORE = {
  id: 1,
  name: "TechZone",
  coverImage: "https://images.unsplash.com/photo-1550009158-9ebf69173e03?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
  logo: "https://images.unsplash.com/photo-1563770660941-10a63257ffde?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
  description: "Votre destination high-tech à Conakry pour tous vos besoins en électronique, smartphones, ordinateurs et accessoires. Service de livraison express et conseil personnalisé.",
  storeType: "Électronique",
  rating: 4.7,
  reviewCount: 412,
  ...
  products: [
    {
      ...
      description: "Smartphone haut de gamme avec écran 6.5 pouces, 128GB de stockage, triple caméra et batterie longue durée",
      price: 3500000,
    ...
    },
    {
      ...
      description: "Laptop performant avec processeur i5, 8GB RAM, 512GB SSD et écran Full HD 15.6 pouces",
      price: 5200000,
    ...
    },
    {
      ...
      description: "Écouteurs Bluetooth avec réduction de bruit active, étui de charge et autonomie de 24h",
      price: 450000,
    ...
    },
    {
      ...
      description: "Chargeur USB-C 30W avec technologie de charge rapide pour smartphones et tablettes",
      price: 125000,
      image: "https://images.unsplash.com/photo-1583863788471-5253ef7f1e52?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: true,
      categoryId: 4
    },
    {
      ...
      description: "Ventilateur oscillant 50W avec télécommande, 3 vitesses et programmation horaire",
      price: 350000,
      image: "https://images.unsplash.com/photo-1527975974326-937597c1e1b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: true,
      categoryId: 6
    },
    {
      id: 6,
      name: "Smartphone d'entrée de gamme",
      description: "Téléphone Android avec écran 6.2 pouces, double SIM, 64GB de stockage et batterie 5000mAh",
      price: 1200000,
    ...
    },
    {
      ...
      description: "Tablette 10 pouces avec processeur octa-core, 4GB RAM, 64GB stockage et connexion 4G",
      price: 1800000,
    ...
    },
    {
      ...
      description: "Coque renforcée anti-choc pour smartphone, design élégant et grip amélioré",
      price: 75000,
      image: "https://images.unsplash.com/photo-1541877590-995a6a886b38?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: false,
      categoryId: 4
    },
    {
      ...
      description: "Enceinte portable sans fil avec son stéréo puissant, résistante à l'eau et autonomie de 12h",
      price: 295000,
    ...
    },
    {
      ...
      description: "Four micro-ondes 25L avec grill, 6 niveaux de puissance et dégivrage automatique",
      price: 425000,
      image: "https://images.unsplash.com/photo-1585240986828-899ddb330639?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      popular: false,
      categoryId: 6
    }
  ]
...
const ElectronicsPage = () => {
  ...
  const store = MOCK_ELECTRONICS_STORE;
  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 pt-4">
        <Link to="/electronic-stores" className="flex items-center text-guinea-red hover:underline mb-2">
          <ChevronLeft className="h-4 w-4 mr-1" />
          Retour aux magasins d'électronique
        </Link>
      </div>
