-- ============================================================================
-- SCRIPT POUR CRÉER LA VUE CART_DETAILS ET LES FONCTIONS NÉCESSAIRES
-- ============================================================================
-- Ce script résout l'erreur "relation 'public.cart_details' does not exist"

-- ============================================================================
-- 1. CRÉER LES FONCTIONS NÉCESSAIRES
-- ============================================================================
...
FROM pg_proc 
WHERE proname IN ('calculate_cart_total', 'get_cart_item_count');
...
SELECT '✅ Fonctions calculate_cart_total et get_cart_item_count créées!' as message;
SELECT '🛒 Le service de panier devrait maintenant fonctionner correctement' as message; 