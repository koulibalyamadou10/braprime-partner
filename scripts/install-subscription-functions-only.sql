-- Script simple pour installer uniquement les fonctions de subscription
-- Exécutez ce script dans votre base de données Supabase

-- Supprimer uniquement les fonctions de subscription qui causent des conflits
...
-- Créer la fonction calculate_subscription_dates
...
-- Créer la fonction create_partner_subscription
...
-- Créer la fonction activate_subscription
...
-- Créer la fonction check_expired_subscriptions
